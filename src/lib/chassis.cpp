...
Chassis::Chassis(const initializer_list<Motor> left, const initializer_list<Motor> right, const initializer_list<Motor> arm,   const int &maxSpeed)
{
	for (Motor mtr : left)
	{
